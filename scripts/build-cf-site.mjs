...
function home() {
  const homeBody = `<section class="home-hero"><div class="home-hero-copy"><h1>Votre projet d'études à l'étranger mérite une stratégie claire.</h1><p class="lead">CF Consulting Travel accompagne les étudiants et les familles dans la préparation de projets de mobilité internationale cohérents, crédibles et défendables.</p><div class="actions"><a class="btn primary" href="${site.whatsappFr}" target="_blank" rel="noreferrer">Parler à un conseiller</a><a class="btn secondary" href="/sgve-2026/">Découvrir SGVE 2026</a></div><div class="hero-proof" aria-label="Indicateurs de confiance"><p><strong>+150</strong><span>visas obtenus</span></p><p><strong>+30</strong><span>recours gagnés</span></p><p><strong>+1000</strong><span>étudiants orientés</span></p><p><strong>5</strong><span>destinations principales</span></p></div></div><figure class="home-editorial" aria-label="Composition visuelle premium autour d'un dossier de mobilité internationale"><div class="editorial-panel"><div class="editorial-topline"><span>CF Mobility Desk</span><b>2026</b></div><div class="editorial-doc"><span>Diagnostic stratégique</span><strong>Projet d'études</strong><p>Profil, parcours, preuves et calendrier.</p><i></i><i></i><i></i></div><div class="editorial-passport"><em></em><strong>Visa étudiant</strong><span>Dossier structuré</span></div><div class="editorial-map"><span>FR</span><span>CA</span><span>ES</span><span>RU</span><span>DE</span></div><div class="editorial-advice"><small>Entretien conseil</small><strong>Feuille de route claire</strong></div></div></figure></section><section class="home-proof-section"><div><p class="section-label">Témoignages et preuves sociales</p><h2>Des résultats utiles, présentés avec prudence et méthode.</h2><p>CF Consulting Travel met l'accent sur la préparation sérieuse : comprendre le profil, clarifier le projet, organiser les preuves et éviter les promesses irréalistes.</p><div class="actions"><a class="btn primary" href="/contact/">Je veux être accompagné</a></div></div><div class="home-proof-grid">${[["+150", "visas obtenus", "Retours positifs documentés par l'équipe, à consolider avec les données internes."], ["+30", "recours gagnés", "Situations de refus relues, analysées et accompagnées avec méthode."], ["+1000", "étudiants orientés", "Étudiants, élèves et jeunes diplômés sensibilisés à la mobilité internationale."], ["5", "destinations principales", "France, Canada, Espagne, Russie et Allemagne."]].map(([value, label, text]) => `<article aria-label="${value} ${label}"><strong>${value}</strong><h3>${label}</h3><p>${text}</p></article>`).join("")}</div></section><section class="home-services" id="services"><div><p class="section-label">Expertise CF Consulting Travel</p><h2>Un accompagnement qui part du profil, pas d'une promesse.</h2><p>Chaque projet international demande une lecture précise : parcours académique, cohérence du choix, ressources, calendrier, documents et préparation du candidat.</p><a class="btn secondary" href="/services/">Voir tous les services</a></div><div class="service-editorial-list"><a href="/visa-etudiant/"><span>01</span><strong>Visa étudiant</strong><small>Projet académique, dossier, cohérence et préparation.</small></a><a href="/recours-visa/"><span>02</span><strong>Recours visa</strong><small>Analyse du refus, points faibles et stratégie corrective.</small></a><a href="/orientation-etudes-etranger/"><span>03</span><strong>Orientation études à l'étranger</strong><small>Pays, école, formation et trajectoire professionnelle.</small></a><a href="/accompagnement-campus-france/"><span>04</span><strong>Campus France</strong><small>Parcours, motivations, documents et entretien.</small></a></div></section><section class="home-method"><p class="section-label">Méthode</p><h2>Diagnostiquer. Structurer. Préparer.</h2><div class="method-rail"><article><span>01</span><h3>Diagnostic</h3><p>Analyse du profil, de la destination, du parcours et des points sensibles.</p></article><article><span>02</span><h3>Feuille de route</h3><p>Priorités, documents, calendrier et cohérence du projet.</p></article><article><span>03</span><h3>Préparation</h3><p>Conseils, relecture, entretien et accompagnement jusqu'aux étapes clés.</p></article></div></section><section class="home-sgve"><div><p class="section-label">Événement signature</p><h2>SGVE 2026, une conférence pour mieux comprendre la stratégie visa étudiant.</h2><p>Le 12 septembre 2026 à 15h00 au Krystal Palace de Douala, CF Consulting Travel réunit étudiants et familles autour d'une feuille de route claire pour préparer un projet d'études à l'étranger.</p></div><div class="sgve-panel"><strong>SGVE 2026</strong><span>Stratégie Gagnante Visa Étudiant</span><p>Accès gratuit sur inscription. Places limitées.</p><a class="btn primary" href="/sgve-2026/">Découvrir SGVE 2026</a></div></section>`;
  return page({
...
async function build() {
  ...
  await writeFile(path.join(out, "styles.css"), finalCss + premiumPolishCss + premiumRedesignV2Css + premiumHeroEditorialCss + premiumHomepageV3Css, "utf8");
