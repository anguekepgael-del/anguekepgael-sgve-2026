...
function home() {
  return page({
    ...
    body: `<section class="hero home"><div><p class="eyebrow">Site officiel</p><h1>CF Consulting Travel accompagne vos projets de mobilité internationale.</h1><p class="lead">Orientation, préparation de dossiers, accompagnement visa et conseils stratégiques pour avancer avec clarté, sans promesse d'obtention garantie.</p><div class="actions"><a class="btn primary" href="/services/">Voir nos services</a><a class="btn secondary" href="${site.whatsappFr}" target="_blank" rel="noreferrer">Nous joindre sur WhatsApp</a><a class="btn secondary" href="/sgve-2026/">SGVE 2026</a></div><p class="note">Une approche premium, sobre et méthodique pour les étudiants, familles, voyageurs et porteurs de projets.</p></div><figure><img src="${visuals.advisory}" alt="Rendez-vous de conseil pour un projet de mobilité internationale" /></figure></section><section class="section" id="services"><p class="eyebrow">Services principaux</p><h2>Un site clair pour chaque besoin : études, voyage, recours et conseil.</h2><div class="grid four">${serviceLinks.map(([title, href, text]) => serviceCard(title, href, text)).join("")}</div></section><section class="section split visual-split" id="methode"><div><p class="eyebrow">Méthode CF</p><h2>Diagnostiquer, structurer, préparer.</h2><p>CF Consulting Travel aide chaque candidat à mieux comprendre son profil, ses objectifs, ses justificatifs et les limites de son dossier avant toute démarche importante.</p><div class="actions"><a class="btn primary" href="/contact/">Contacter l'équipe</a><a class="btn secondary" href="/a-propos/">À propos de CF</a></div></div><ol class="timeline"><li><strong>Diagnostic</strong><span>Analyse du profil, de la destination et du besoin réel.</span></li><li><strong>Feuille de route</strong><span>Priorités, documents, calendrier et points de vigilance.</span></li><li><strong>Préparation</strong><span>Conseils, relecture et accompagnement jusqu'aux étapes clés.</span></li></ol></section>${socialProofSection({ title: "Témoignages et preuves sociales : des étudiants et parents accompagnés avec méthode.", text: "Les retours ci-dessous montrent ce que les visiteurs recherchent avant de confier leur projet : de la clarté, une méthode, des explications fiables et un accompagnement humain adapté au contexte camerounais.", limit: 3 })}<section class="banner event-strip"><div><p class="eyebrow">Événement officiel</p><h2>SGVE 2026 - ${ev.long}</h2><p>${ev.date} à ${ev.time} - ${ev.place}. Conférence gratuite sur inscription.</p></div><img src="${visuals.conference}" alt="" aria-hidden="true" loading="lazy" /><div class="actions"><a class="btn primary" href="/sgve-2026/">Réserver ma place à SGVE 2026</a><a class="btn secondary light" href="${site.whatsappFr}" target="_blank" rel="noreferrer">Nous joindre sur WhatsApp</a></div></section>`,
  });
}
