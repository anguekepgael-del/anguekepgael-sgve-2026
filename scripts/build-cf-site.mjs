...
function legal(kind) {
  const data = {
    ...
    privacy: ["Politique de confidentialite", "Les donnees du formulaire SGVE 2026 servent a enregistrer l'inscription, envoyer un billet et transmettre les informations pratiques.", "Elles ne sont pas publiees et peuvent etre stockees dans les outils techniques du site.", `Pour toute demande : ${site.email}.`],
