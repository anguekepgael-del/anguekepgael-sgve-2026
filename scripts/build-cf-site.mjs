...
const ev = {
  title: "SGVE 2026",
  long: "StratÃ©gie Gagnante Visa Ã‰tudiant",
...
function sgve() {
  return page({
    title: `${ev.title} - ${ev.long} Ã  Douala`,
