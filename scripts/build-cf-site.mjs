...
const socialCss = `.proof-card h3{color:var(--o);font-size:clamp(1.5rem,2.2vw,2.4rem);line-height:1}.quote-head{display:flex;gap:14px;align-items:center;margin-bottom:12px}.avatar{display:inline-flex;justify-content:center;align-items:center;width:54px;height:54px;border-radius:999px;background:#0a0a0a;color:#fff;border:2px solid var(--o);font-weight:950;flex:0 0 auto}.result{padding:12px 14px;border-radius:16px;background:#fff7ed;color:#7c2d12}.testimonial,.case-card{display:flex;flex-direction:column}.testimonial .eyebrow{margin-bottom:4px}`;
